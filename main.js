...
const inputQuitarTextoSuperior = document.getElementById(
	"quitar-texto-superior"
);
const inputQuitarTextoInferior = document.getElementById(
...
const inputFondoTransparente = document.getElementById(
...
const cambiarTextoModo = () => {
	...
	if (modoActual === "oscuro") {
		btnCambiarModo.innerHTML =
			'<i class="fa-solid fa-lightbulb"></i> Modo claro';
		btnCambiarModo.setAttribute("data-modo", "claro");
	} else {
		btnCambiarModo.innerHTML =
			'<i class="fa-solid fa-lightbulb"></i> Modo oscuro';
